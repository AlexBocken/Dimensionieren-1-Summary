...
\section{Materialverhalten}{}
    \subsection{Festigkeitshypothesen}
        ...
        \subsubsection{Tresca'sche Vergleichsspannung}
            ...
            \vspace{-2mm}\[\sigma_{\textrm{Tresca}}^{vgl}=\frac{1}{2}\textrm{max} \left(|\sigma_1-\sigma_2|,|\sigma_2-\sigma_3|,|\sigma_3-\sigma_1| \right) =\tau_0=\frac{\sigma_0}{2}\]
...
\vfill\null\columnbreak
        ...
        \subsubsection{Formfaktoren}
            ...
            \begin{center}
                \includegraphics[width=0.7\linewidth]{04/formfaktoren.png}
            \end{center}
