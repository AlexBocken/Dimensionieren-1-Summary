...
\lhead{\textbf{Dimensionieren I HS19 Prof. Dr. Mazza}}
...
\mysec{Materialverhalten}{}
    ...
    \mysubsec{Statische Belastung:}
        \begin{comment}
            \mysubsubsec{Kraft- \& Deformationsgesteurete Belastung:}
        ...
        \end{comment}
        \mysubsubsec{Spannungsverteilung:}
