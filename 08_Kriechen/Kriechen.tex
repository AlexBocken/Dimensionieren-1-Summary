\section{Kriechen}
    ...
    \subsection{Relaxation}
        \subsubsection{Nach Norton}
            ...
            \vspace{-2mm}\[\varepsilon_{cr}+\varepsilon_{el}=\varepsilon_0=\textrm{const.} \qquad \dot{\varepsilon}_{cr}+\dot{\varepsilon}_{el}=0 \Rightarrow A\sigma^n + \frac{\dot{\sigma}}{E}=0\]
